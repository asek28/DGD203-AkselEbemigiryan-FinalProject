...
//Hocam bazı şeyleri mantığını anlasamda çalıştırmayı başaramadım koduma entegre etmek zor geldi çünkü hatalarımı geç fark ettim baştan yazmam lazımdı çözebilmek için ama yapamadım bunun bahane olduğunun farkındayım ama kusura bakmayın.
namespace Final
{
    internal class GameController
    {
        ...
        public void StartGame()
        {
            ...
            {
                Console.WriteLine("Okay, I realize you're a little shy, but I don't care what your name is, I'm going to call you Alan Grant, after my old friend.");
