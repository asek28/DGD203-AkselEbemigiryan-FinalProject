...
//Hocam bazı şeyleri mantığını anlasamda çalıştırmayı başaramadım koduma entegre etmek zor geldi baştan yazmam lazımdı çözebilmek için ama yapamadım bunun bahane olduğunun farkındayım ama kusura bakmayın.
namespace Final
{
